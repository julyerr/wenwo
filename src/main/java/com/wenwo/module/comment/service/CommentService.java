package com.wenwo.module.comment.service;

import com.wenwo.config.MailTemplateConfig;
import com.wenwo.config.SiteConfig;
import com.wenwo.core.util.EmailUtil;
...
import com.wenwo.module.comment.repository.CommentRepository;
...
//            TODO 删除所有对应话题，还是标记为已经删除，本身post comment都不能删除
...
//            topicService.save(topic);
            ...
            String content = "该内容已经被删除";
            commentRepository.fakeDeleteId(content,id);
            // 计算weight
...
//    对topic的评论commentid为空，使用递归的方式顺序将对话layer加进来
